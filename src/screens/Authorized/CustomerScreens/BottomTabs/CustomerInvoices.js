        ...
        <View
          ...
          <TouchableOpacity
            style={{
              ...
              justifyContent: 'center',
              flex: 1,
              borderWidth: invoiceTab == 1 ? 0 : 1,
              borderColor: 'grey',
              borderRightWidth: 0,
            }}
            onPress={hadleAllInvoices}>
            <Text style={{color: invoiceTab == 1 ? COLORS.white : 'grey'}}>
              All
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              ...
              justifyContent: 'center',
              flex: 1,
              borderWidth: invoiceTab == 2 ? 0 : 1,
              borderColor: 'grey',
              borderRightWidth: 0,
            }}
            onPress={hadlePaidInvoices}>
            <Text style={{color: invoiceTab == 2 ? COLORS.white : 'grey'}}>
              Paid
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              ...
              justifyContent: 'center',
              flex: 1,
              borderWidth: invoiceTab == 3 ? 0 : 1,
              borderColor: 'grey',
              borderRightWidth: 0,
            }}
            onPress={hadleUnpaidInvoices}>
            <Text style={{color: invoiceTab == 3 ? COLORS.white : 'grey'}}>
              Unpaid
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              ...
              alignItems: 'center',
              justifyContent: 'center',
              borderWidth: invoiceTab == 4 ? 0 : 1,
              borderColor: 'grey',
              flex: 1,
            }}
            onPress={hadlePartialInvoices}>
            <Text style={{color: invoiceTab == 4 ? COLORS.white : 'grey'}}>
              Partially Paid
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={{marginTop: 30}}>
            ...
            >
              <LinearGradient
                ...
                <View>
                  <Text style={{color: COLORS.black}}>2000$</Text>
                  <View
                    style={{
            ...
            >
              <LinearGradient
                ...
                <View>
                  <Text style={{color: COLORS.white}}>Hassan Ali</Text>
                  <Text style={{color: COLORS.white, marginTop: 5}}>
                    07/03/2022
                  </Text>
                </View>
                ...
                <View>
                  <Text style={{color: COLORS.black}}>3629$</Text>
                  <View
                    style={{
                      backgroundColor: 'red',
                      alignItems: 'center',
                    ...
                    <Text style={{color: COLORS.white}}>Unpaid</Text>
                  </View>
                </View>
              </LinearGradient>
            </TouchableOpacity>
